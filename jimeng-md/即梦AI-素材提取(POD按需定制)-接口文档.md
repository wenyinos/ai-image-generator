<span id="zAtOsdgg"></span>
# 接口简介
通过智能图案提取技术，从实物商品中精准提取并矢量化核心图案，生成平面设计图，提升电商领域中商品打版和产品设计等场景的制作效率。
<span id="rv44XD7e"></span>
# 接入说明
<span id="VUhQgdzq"></span>
## 限制条件
...
<span id="5KkL01fK"></span>
## 提交任务
<span id="5HqrokHu"></span>
### **提交任务请求参数**
<span id="PSh9mVXv"></span>
#### **Query参数**
...
<span id="gJ0w0vgm"></span>
### 提交任务返回参数
<span id="tg8XShYr"></span>
#### **通用返回参数**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="e6V5akV3"></span>
#### **业务返回参数**
...
<span id="Jasw5AEL"></span>
## 查询任务
<span id="mvabTTND"></span>
### **查询任务请求参数**
<span id="BFRZ2ZAS"></span>
#### **Query参数**
...
<span id="ksxzndOA"></span>
#### **Header参数**
:::warning
本服务固定值：**Region为cn\-north\-1，Service为cv**
:::
主要用于鉴权，详见 [公共参数](https://www.volcengine.com/docs/6369/67268) \- 签名参数 \- 在Header中的场景部分
<span id="1foog1YQ"></span>
#### **Body参数**
:::warning
业务请求参数，放到request.body中，MIME\-Type为**application/json**
...
<span id="Hj9KNadB"></span>
### 查询任务返回参数
<span id="ACziZmLu"></span>
#### **通用返回参数**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="5AoAlfoR"></span>
#### **业务返回参数**
:::tip
...
<span id="zLjxARnS"></span>
## 错误码
<span id="FVvqX3oJ"></span>
### **通用错误码**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="hGVC9nOc"></span>
### **业务错误码**
...
&nbsp;
<span id="o5Pb7fOa"></span>
## 接入说明
<span id="3gChnOKJ"></span>
### SDK使用说明
请参考[SDK使用说明](https://www.volcengine.com/docs/6444/1340578)
<span id="rXOD3bp6"></span>
### HTTP方式接入说明
