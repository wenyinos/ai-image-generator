...
router.post('/generate-video', (req, res, next) => {
  ...
  const maxDuration = selectedModel === 'wan3.0-video' ? 30 : 15;
  ...
  } else if (selectedMode === 'image2video' && (selectedModel.startsWith('wan2.7-i2v') || selectedModel === 'wan3.0-video')) {
  ...
  if (selectedMode === 'text2video' && params.ratio) {
    if (selectedModel.startsWith('wan2.7-t2v') || selectedModel === 'happyhorse-1.0-t2v' || selectedModel === 'wan3.0-video') {
