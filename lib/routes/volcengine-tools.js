...
const { parseVolcengineCredentials, submitVolcengineTask, callVolcengineSync, saveUploadedImageAsPublicUrl, extractVolcengineImageUrls, volcengineSign, volcengineCanonicalQuery, fetchWithTimeout } = require('../utils');
const { VOLCENGINE_HOST, VOLCENGINE_SERVICE, VOLCENGINE_REGION, VOLCENGINE_VERSION, GENERATION_REQUEST_TIMEOUT_MS } = require('../config');
