...
// 千问/万相图像 generation 异步任务端点（X-DashScope-Async: enable 提交，轮询 /tasks/{id}）
const IMAGE_GENERATION_ASYNC_ENDPOINT = '/services/aigc/image-generation/generation';
...
const MODEL_CONFIG = {
  ...
  'agnes-image-2.5-flash': { size: '1024x768', type: 'agnes' },
  ...
  'gpt-image-2-4k': { size: '4K', type: 'openai' },
  'image2.5': { size: '1K', type: 'openai' },
};
...
const ALLOWED_SIZES_BY_MODEL = {
  ...
  'agnes-image-2.5-flash': ['1024x1024', '1024x768', '768x1024', '1280x720', '720x1280', '1152x896', '896x1152'],
